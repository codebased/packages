    ...
    public static class LogManager
    {
        ...
        public static Exception Log(XElement xElement, Severity severity = Severity.Info, bool useBackgroundTask = true, int framesToSkip = 0)
        {
            ...
            try
            {
                ...
                logEntry.Add(new XAttribute("Identity", Thread.CurrentPrincipal.Identity.Name));
                logEntry.Add(new XAttribute("IsAuthenticated", Thread.CurrentPrincipal.Identity.IsAuthenticated));
        ...
        private static string GetCaller(int framesToSkip = 0)
        {
            ...
            while (true)
            {
                ...
                if (declaringType != typeof(LogManager) && --framesToSkip < 0)
                    break;
            }
