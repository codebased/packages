...
namespace Ap.Common.CloudMaker
{
    ...
    public class TagCloudGenerationRules
    {
        ...
        private int _requiredTagWeight;
        private string _tagToolTipFormatString;
        private string _tagCssClassPrefix;
        ...
        /// {
        ///     TagCssClassPrefix = "TagWeight",
        ///     WeightClassPartitioning = new ReadOnlyCollection &lt;int;gt;(new[] { 50, 50 })"
        /// }
        /// </code>
        ...
        public ReadOnlyCollection<int> WeightClassPartitioning
		{
			...
			set
			{
				...
				_weightClassPartitioning = value.ToArray();
			}
        }
